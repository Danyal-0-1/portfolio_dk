...
import projects__happenstanceAvatarMdx from './projects__happenstance-avatar.mdx.json' with { type: 'json' }
...
import projects__observationApparatusMdx from './projects__observation-apparatus.mdx.json' with { type: 'json' }
...
export const allProjects = [projects__happenstanceAvatarMdx, projects__mesquiteMocapMdx, projects__multiPhone_3dRigMdx, projects__observationApparatusMdx, projects__opuntiaMdx, projects__sirenDiffusionMdx, projects__tftFinanceMdx, projects__toWiltMotionglbMdx, projects__toWiltMdx, projects__visionRepresentationMdx]

...
export function ProjectCard({ project }: { project: Project }) {
  return (
    <Link
      href={project.url}
      className="group rounded-2xl border border-slate-200 bg-white/80 p-4 flex flex-col gap-3 shadow-sm hover:shadow-md hover:border-accent/70 hover:-translate-y-0.5 transition dark:border-slate-800 dark:bg-slate-900/40"
    >
